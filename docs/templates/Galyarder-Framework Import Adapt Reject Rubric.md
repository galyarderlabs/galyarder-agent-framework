...
## The Three Outcomes
### Import
Use when the external skill is already strong, reusable, and close to Galyarder Framework quality with minimal changes.
...
- workflow tightening
- Galyarder Framework-specific reporting or department fit
...
### 3. Capability Gap
Questions:
- Is Galyarder Framework currently weak in this area?
...
Questions:
- Does it fit Galyarder Framework's constitution?
