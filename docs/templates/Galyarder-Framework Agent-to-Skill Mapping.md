...
The goal is to stop thinking of Galyarder Framework as a flat skill library and instead treat each agent as a manager or functional owner with a defined team underneath.
