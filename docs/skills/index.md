...
-   **[board-update](../skills/board-update/index.md)**
...
-   **[brainstorming](../skills/brainstorming/index.md)**

    ---

    You MUST use this before any creative work - creating features, building components, adding functionality, or modifying behavior. Explores user intent, requirements and design before implementation.
-   **[data-room](../skills/data-room/index.md)**
...
-   **[founder-context](../skills/founder-context/index.md)**
...
-   **[founder-thought-leadership](../skills/founder-thought-leadership/index.md)**
...
-   **[fundraising-email](../skills/fundraising-email/index.md)**
...
-   **[investor-research](../skills/investor-research/index.md)**
...
-   **[lead-scoring](../skills/lead-scoring/index.md)**
...
-   **[market-research](../skills/market-research/index.md)**
...
-   **[pitch-deck](../skills/pitch-deck/index.md)**
...
-   **[using-galyarder-framework](../skills/using-galyarder-framework/index.md)**

    ---

    Use when starting any conversation - establishes how to find and use skills, requiring Skill tool invocation before ANY response including clarifying questions
-   **[writing-skills](../skills/writing-skills/index.md)**
...
-   **[playwright-pro](../skills/playwright-pro/index.md)**

    ---

    Production-grade Playwright testing toolkit. Use when the user mentions Playwright tests, end-to-end testing, browser automation, fixing flaky tests, test migration, CI/CD testing, or test suites. Generate tests, fix flaky failures, migrate from Cypress/Selenium, sync with TestRail, run on BrowserStack. 55 templates, 3 agents, smart reporting.
-   **[receiving-code-review](../skills/receiving-code-review/index.md)**

    ---

    Use when receiving code review feedback, before implementing suggestions, especially if feedback seems unclear or technically questionable - requires technical rigor and verification, not performative agreement or blind implementation
-   **[requesting-code-review](../skills/requesting-code-review/index.md)**

    ---

    Use when completing tasks, implementing major features, or before merging to verify work meets requirements
-   **[subagent-driven-development](../skills/subagent-driven-development/index.md)**

    ---

    Use when executing implementation plans with independent tasks in the current session
-   **[systematic-debugging](../skills/systematic-debugging/index.md)**

    ---

    Use when encountering any bug, test failure, or unexpected behavior, before proposing fixes
-   **[test-driven-development](../skills/test-driven-development/index.md)**

    ---

    Use when implementing any feature or bugfix, before writing implementation code
-   **[vercel-react-best-practices](../skills/vercel-react-best-practices/index.md)**

    ---

    React and Next.js performance optimization guidelines from Vercel Engineering. This skill should be used when writing, reviewing, or refactoring React/Next.js code to ensure optimal performance patterns. Triggers on tasks involving React components, Next.js pages, data fetching, bundle optimization, or performance improvements.
-   **[verification-before-completion](../skills/verification-before-completion/index.md)**
...
-   **[analytics-tracking](../skills/analytics-tracking/index.md)**

    ---

    Design, audit, and improve analytics tracking systems that produce reliable, decision-ready data.
-   **[campaign-analytics](../skills/campaign-analytics/index.md)**
...
-   **[competitor-alternatives](../skills/competitor-alternatives/index.md)**

    ---

    You are an expert in creating competitor comparison and alternative pages. Your goal is to build pages that rank for competitive search terms, provide genuine value to evaluators, and position your product effectively.
-   **[content-creator](../skills/content-creator/index.md)**
...
-   **[content-strategy](../skills/content-strategy/index.md)**
...
-   **[copywriting](../skills/copywriting/index.md)**
...
-   **[email-marketing-bible](../skills/email-marketing-bible/index.md)**

    ---

    >
-   **[marketing-demand-acquisition](../skills/marketing-demand-acquisition/index.md)**
...
-   **[marketing-ideas](../skills/marketing-ideas/index.md)**
...
-   **[marketing-psychology](../skills/marketing-psychology/index.md)**
...
-   **[onboarding-cro](../skills/onboarding-cro/index.md)**

    ---

    You are an expert in user onboarding and activation. Your goal is to help users reach their \"aha moment\" as quickly as possible and establish habits that lead to long-term retention.
-   **[page-cro](../skills/page-cro/index.md)**

    ---

    Analyze and optimize individual pages for conversion performance.
-   **[paywall-upgrade-cro](../skills/paywall-upgrade-cro/index.md)**

    ---

    You are an expert in in-app paywalls and upgrade flows. Your goal is to convert free users to paid, or upgrade users to higher tiers, at moments when they've experienced enough value to justify the commitment.
-   **[programmatic-seo](../skills/programmatic-seo/index.md)**
...
-   **[referral-program](../skills/referral-program/index.md)**
...
-   **[eradicating-malware-from-infected-systems](../skills/eradicating-malware-from-infected-systems/index.md)**
...
-   **[executing-active-directory-attack-simulation](../skills/executing-active-directory-attack-simulation/index.md)**

    ---

    >
-   **[executing-phishing-simulation-campaign](../skills/executing-phishing-simulation-campaign/index.md)**

    ---

    >
-   **[executing-red-team-engagement-planning](../skills/executing-red-team-engagement-planning/index.md)**
...
-   **[executing-red-team-exercise](../skills/executing-red-team-exercise/index.md)**

    ---

    >
-   **[generating-threat-intelligence-reports](../skills/generating-threat-intelligence-reports/index.md)**

    ---

    >
-   **[intercepting-mobile-traffic-with-burpsuite](../skills/intercepting-mobile-traffic-with-burpsuite/index.md)**

    ---

    >
-   **[investigating-phishing-email-incident](../skills/investigating-phishing-email-incident/index.md)**

    ---

    >
-   **[mapping-mitre-attack-techniques](../skills/mapping-mitre-attack-techniques/index.md)**

    ---

    >
-   **[monitoring-darkweb-sources](../skills/monitoring-darkweb-sources/index.md)**

    ---

    >
-   **[profiling-threat-actor-groups](../skills/profiling-threat-actor-groups/index.md)**

    ---

    >
-   **[recovering-deleted-files-with-photorec](../skills/recovering-deleted-files-with-photorec/index.md)**
...
-   **[recovering-from-ransomware-attack](../skills/recovering-from-ransomware-attack/index.md)**

    ---

    >
-   **[reverse-engineering-malware-with-ghidra](../skills/reverse-engineering-malware-with-ghidra/index.md)**

    ---

    >
-   **[testing-for-xss-vulnerabilities-with-burpsuite](../skills/testing-for-xss-vulnerabilities-with-burpsuite/index.md)**
...
-   **[tracking-threat-actor-infrastructure](../skills/tracking-threat-actor-infrastructure/index.md)**
...
-   **[prd-to-issues](../skills/prd-to-issues/index.md)**
...
-   **[prd-to-plan](../skills/prd-to-plan/index.md)**

    ---

    Turn a PRD into a multi-phase implementation plan using tracer-bullet vertical slices, saved as a local Markdown file in ./plans/. Use when user wants to break down a PRD, create an implementation plan, plan phases from a PRD, or mentions "tracer bullets".
-   **[ubiquitous-language](../skills/ubiquitous-language/index.md)**

    ---

    Extract a DDD-style ubiquitous language glossary from the current conversation, flagging ambiguities and proposing canonical terms. Saves to UBIQUITOUS_LANGUAGE.md. Use when user wants to define domain terms, build a glossary, harden terminology, create a ubiquitous language, or mentions "domain model" or "DDD".
-   **[write-a-prd](../skills/write-a-prd/index.md)**

    ---

    Create a PRD through user interview, codebase exploration, and module design, then submit as a GitHub issue. Use when user wants to write a PRD, create a product requirements document, or plan a new feature.
-   **[writing-plans](../skills/writing-plans/index.md)**
...
-   **[contract-and-proposal-writer](../skills/contract-and-proposal-writer/index.md)**

    ---

    >
-   **[contract-review](../skills/contract-review/index.md)**

    ---

    Analyze and red-flag contracts systematically, identifying risks, unfavorable terms, and negotiation opportunities
-   **[finance-based-pricing-advisor](../skills/finance-based-pricing-advisor/index.md)**
...
-   **[financial-analyst](../skills/financial-analyst/index.md)**
...
-   **[gdpr-ccpa-privacy-auditor](../skills/gdpr-ccpa-privacy-auditor/index.md)**
...
-   **[gdpr-compliance](../skills/gdpr-compliance/index.md)**
...
-   **[iso-42001-ai-governance](../skills/iso-42001-ai-governance/index.md)**
...
-   **[legal-advisor](../skills/legal-advisor/index.md)**
...
-   **[legal-tos-privacy](../skills/legal-tos-privacy/index.md)**
...
-   **[open-source-license](../skills/open-source-license/index.md)**
...
-   **[saas-finops-optimization](../skills/saas-finops-optimization/index.md)**
...
-   **[json-canvas](../skills/json-canvas/index.md)**

    ---

    Create and edit JSON Canvas files (.canvas) with nodes, edges, groups, and connections. Use when working with .canvas files, creating visual canvases, mind maps, flowcharts, or when the user mentions Canvas files in Obsidian.
-   **[obsidian-bases](../skills/obsidian-bases/index.md)**

    ---

    Create and edit Obsidian Bases (.base files) with views, filters, formulas, and summaries. Use when working with .base files, creating database-like views of notes, or when the user mentions Bases, table views, card views, filters, or formulas in Obsidian.
-   **[obsidian-cli](../skills/obsidian-cli/index.md)**

    ---

    Interact with Obsidian vaults using the Obsidian CLI to read, create, search, and manage notes, tasks, properties, and more. Also supports plugin and theme development with commands to reload plugins, run JavaScript, capture errors, take screenshots, and inspect the DOM. Use when the user asks to interact with their Obsidian vault, manage notes, search vault content, perform vault operations from the command line, or develop and debug Obsidian plugins and themes.
-   **[obsidian-markdown](../skills/obsidian-markdown/index.md)**
