---
title: "Executing Red Team Engagement Planning  Claude Code Plugin & Agent Skill"
description: "Red team engagement planning is the foundational phase that defines scope, objectives, rules of engagement (ROE), threat model selection, and. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge"> `executing-red-team-engagement-planning`</span>
<span class="meta-badge"> <a href="https://github.com/galyarderlabs/galyarder-framework/tree/main/skills/executing-red-team-engagement-planning/SKILL.md">Source</a></span>
</div>
