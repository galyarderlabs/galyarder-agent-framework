---
title: "Finishing A Development Branch  Claude Code Plugin & Agent Skill"
description: "Use when implementation is complete, all tests pass, and you need to decide how to integrate the work - guides completion of development work by. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge"> `finishing-a-development-branch`</span>
<span class="meta-badge"> <a href="https://github.com/galyarderlabs/galyarder-framework/tree/main/skills/finishing-a-development-branch/SKILL.md">Source</a></span>
</div>
