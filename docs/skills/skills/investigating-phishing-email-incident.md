---
title: "Investigating Phishing Email Incident  Claude Code Plugin & Agent Skill"
description: "Investigates phishing email incidents from initial user report through header analysis, URL/attachment detonation, impacted user identification, and. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge"> `investigating-phishing-email-incident`</span>
<span class="meta-badge"> <a href="https://github.com/galyarderlabs/galyarder-framework/tree/main/skills/investigating-phishing-email-incident/SKILL.md">Source</a></span>
</div>
