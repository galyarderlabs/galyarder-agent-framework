---
title: "Conversion Engineer  Claude Code Plugin & Agent Skill"
description: "CRO (Conversion Rate Optimization) and Funnel specialist. Use this agent to design onboarding flows, optimize signup forms, and maximize paywall. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge"> `conversion-engineer`</span>
<span class="meta-badge"> <a href="https://github.com/galyarderlabs/galyarder-framework/tree/main/skills/conversion-engineer/SKILL.md">Source</a></span>
</div>
