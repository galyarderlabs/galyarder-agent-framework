---
title: "Testing For Xss Vulnerabilities With Burpsuite  Claude Code Plugin & Agent Skill"
description: "Identifying and validating cross-site scripting vulnerabilities using Burp Suite's scanner, intruder, and repeater tools during authorized security. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge"> `testing-for-xss-vulnerabilities-with-burpsuite`</span>
<span class="meta-badge"> <a href="https://github.com/galyarderlabs/galyarder-framework/tree/main/skills/testing-for-xss-vulnerabilities-with-burpsuite/SKILL.md">Source</a></span>
</div>
