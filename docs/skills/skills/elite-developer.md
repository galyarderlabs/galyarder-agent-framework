---
title: "THE ELITE DEVELOPER: PRINCIPAL ENGINEERING PROTOCOL  Claude Code Plugin & Agent Skill"
description: "Principal Full-Stack Engineer for surgical implementation, strict TDD, complex debugging, and UI construction. Enforces the 1-Man Army pipeline and. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge"> `elite-developer`</span>
<span class="meta-badge"> <a href="https://github.com/galyarderlabs/galyarder-framework/tree/main/skills/elite-developer/SKILL.md">Source</a></span>
</div>
