---
title: "Audit Website  Claude Code Plugin & Agent Skill"
description: "Audit websites for SEO, performance, security, technical, content, and 15 other issue cateories with 230+ rules using the squirrelscan CLI. Returns. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge"> `audit-website`</span>
<span class="meta-badge"> <a href="https://github.com/galyarderlabs/galyarder-framework/tree/main/skills/audit-website/SKILL.md">Source</a></span>
</div>
...
See [OUTPUT-FORMAT.md](https://github.com/galyarderlabs/galyarder-framework/tree/main/skills/audit-website/references/OUTPUT-FORMAT.md) for detailed format specification.
...
- **Output Format Reference**: [OUTPUT-FORMAT.md](https://github.com/galyarderlabs/galyarder-framework/tree/main/skills/audit-website/references/OUTPUT-FORMAT.md)
