---
title: "Tracking Threat Actor Infrastructure  Claude Code Plugin & Agent Skill"
description: "Threat actor infrastructure tracking involves monitoring and mapping adversary-controlled assets including command-and-control (C2) servers, phishing. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge"> `tracking-threat-actor-infrastructure`</span>
<span class="meta-badge"> <a href="https://github.com/galyarderlabs/galyarder-framework/tree/main/skills/tracking-threat-actor-infrastructure/SKILL.md">Source</a></span>
</div>
