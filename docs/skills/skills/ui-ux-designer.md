---
title: "THE UI/UX DESIGNER: HEAD OF DESIGN PROTOCOL  Claude Code Plugin & Agent Skill"
description: "UI/UX and Frontend Design specialist. Use this agent to generate high-fidelity UI components, manage design tokens, and enforce aesthetic consistency. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge"> `ui-ux-designer`</span>
<span class="meta-badge"> <a href="https://github.com/galyarderlabs/galyarder-framework/tree/main/skills/ui-ux-designer/SKILL.md">Source</a></span>
</div>
