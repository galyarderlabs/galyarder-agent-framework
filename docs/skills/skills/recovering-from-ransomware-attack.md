---
title: "Recovering From Ransomware Attack  Claude Code Plugin & Agent Skill"
description: "Executes structured recovery from a ransomware incident following NIST and CISA frameworks, including environment isolation, forensic evidence. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge"> `recovering-from-ransomware-attack`</span>
<span class="meta-badge"> <a href="https://github.com/galyarderlabs/galyarder-framework/tree/main/skills/recovering-from-ransomware-attack/SKILL.md">Source</a></span>
</div>
