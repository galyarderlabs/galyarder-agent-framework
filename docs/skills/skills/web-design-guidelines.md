---
title: "Web Design Guidelines  Claude Code Plugin & Agent Skill"
description: "Review files for compliance with Web Interface Guidelines. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge"> `web-design-guidelines`</span>
<span class="meta-badge"> <a href="https://github.com/galyarderlabs/galyarder-framework/tree/main/skills/web-design-guidelines/SKILL.md">Source</a></span>
</div>
