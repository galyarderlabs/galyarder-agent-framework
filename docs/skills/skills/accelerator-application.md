---
title: "Accelerator Application  Claude Code Plugin & Agent Skill"
description: "Accelerator Application Specialist. Use to shortlist startup programs, draft applications, prepare founder videos, and rehearse accelerator. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge"> `accelerator-application`</span>
<span class="meta-badge"> <a href="https://github.com/galyarderlabs/galyarder-framework/tree/main/skills/accelerator-application/SKILL.md">Source</a></span>
</div>
