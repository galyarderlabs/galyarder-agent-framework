---
title: "Obsidian Bases  Claude Code Plugin & Agent Skill"
description: "Create and edit Obsidian Bases (.base files) with views, filters, formulas, and summaries. Use when working with .base files, creating database-like. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge"> `obsidian-bases`</span>
<span class="meta-badge"> <a href="https://github.com/galyarderlabs/galyarder-framework/tree/main/skills/obsidian-bases/SKILL.md">Source</a></span>
</div>
...
Most commonly used functions. For the complete reference of all types (Date, String, Number, List, File, Link, Object, RegExp), see [FUNCTIONS_REFERENCE.md](https://github.com/galyarderlabs/galyarder-framework/tree/main/skills/obsidian-bases/references/FUNCTIONS_REFERENCE.md).
...
- [Complete Functions Reference](https://github.com/galyarderlabs/galyarder-framework/tree/main/skills/obsidian-bases/references/FUNCTIONS_REFERENCE.md)
