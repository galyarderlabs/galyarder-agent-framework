---
title: "ISO 42001 AI Governance Audit Report  Claude Code Plugin & Agent Skill"
description: "AI governance audit using ISO 42001 standard. Ensures AI systems are developed and deployed responsibly with risk management, ethics, security. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge"> `iso-42001-ai-governance`</span>
<span class="meta-badge"> <a href="https://github.com/galyarderlabs/galyarder-framework/tree/main/skills/iso-42001-ai-governance/SKILL.md">Source</a></span>
</div>
