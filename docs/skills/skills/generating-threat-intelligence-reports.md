---
title: "Generating Threat Intelligence Reports  Claude Code Plugin & Agent Skill"
description: "Generates structured cyber threat intelligence reports at strategic, operational, and tactical levels tailored to specific audiences including. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge"> `generating-threat-intelligence-reports`</span>
<span class="meta-badge"> <a href="https://github.com/galyarderlabs/galyarder-framework/tree/main/skills/generating-threat-intelligence-reports/SKILL.md">Source</a></span>
</div>
