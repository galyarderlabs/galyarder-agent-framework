---
title: "Qa Automation Engineer  Claude Code Plugin & Agent Skill"
description: "E2E Testing and Browser Automation specialist. Use this agent to verify user flows, catch regressions, and audit UI alignment using the BrowserOS. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge"> `qa-automation-engineer`</span>
<span class="meta-badge"> <a href="https://github.com/galyarderlabs/galyarder-framework/tree/main/skills/qa-automation-engineer/SKILL.md">Source</a></span>
</div>
