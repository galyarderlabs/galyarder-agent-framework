---
title: "Analytics Tracking  Claude Code Plugin & Agent Skill"
description: "Design, audit, and improve analytics tracking systems that produce reliable, decision-ready data. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge"> `analytics-tracking`</span>
<span class="meta-badge"> <a href="https://github.com/galyarderlabs/galyarder-framework/tree/main/skills/analytics-tracking/SKILL.md">Source</a></span>
</div>
