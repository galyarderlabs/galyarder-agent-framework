---
title: "Marketing Psychology  Claude Code Plugin & Agent Skill"
description: "Apply behavioral science and mental models to revenue (cuan) decisions, prioritized using a psychological leverage and feasibility scoring system. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge"> `marketing-psychology`</span>
<span class="meta-badge"> <a href="https://github.com/galyarderlabs/galyarder-framework/tree/main/skills/marketing-psychology/SKILL.md">Source</a></span>
</div>
