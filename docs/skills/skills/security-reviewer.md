---
title: "Security Reviewer  Claude Code Plugin & Agent Skill"
description: "Security vulnerability detection and remediation specialist. Use PROACTIVELY after writing code that handles user input, authentication, API. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge"> `security-reviewer`</span>
<span class="meta-badge"> <a href="https://github.com/galyarderlabs/galyarder-framework/tree/main/skills/security-reviewer/SKILL.md">Source</a></span>
</div>
