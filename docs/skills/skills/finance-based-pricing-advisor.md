---
title: "Finance Based Pricing Advisor  Claude Code Plugin & Agent Skill"
description: "Evaluate pricing changes using ARPU, conversion, churn risk, NRR, and payback. Use when deciding whether a pricing move should ship. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge"> `finance-based-pricing-advisor`</span>
<span class="meta-badge"> <a href="https://github.com/galyarderlabs/galyarder-framework/tree/main/skills/finance-based-pricing-advisor/SKILL.md">Source</a></span>
</div>
...
Use [`workshop-facilitation`](https://github.com/galyarderlabs/galyarder-framework/tree/main/skills/workshop-facilitation/SKILL.md) as the default interaction protocol for this skill.
