---
title: "Revenue Architect  Claude Code Plugin & Agent Skill"
description: "Monetization and pricing strategy specialist. Use this agent to design revenue models, set price points based on value perception, and create viral. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge"> `revenue-architect`</span>
<span class="meta-badge"> <a href="https://github.com/galyarderlabs/galyarder-framework/tree/main/skills/revenue-architect/SKILL.md">Source</a></span>
</div>
