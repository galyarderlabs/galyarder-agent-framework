---
title: "Gdpr Ccpa Privacy Auditor  Claude Code Plugin & Agent Skill"
description: "Audits web applications to ensure declared privacy policies match actual technical data collection practices. Use to identify discrepancies in cookie. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge"> `gdpr-ccpa-privacy-auditor`</span>
<span class="meta-badge"> <a href="https://github.com/galyarderlabs/galyarder-framework/tree/main/skills/gdpr-ccpa-privacy-auditor/SKILL.md">Source</a></span>
</div>
