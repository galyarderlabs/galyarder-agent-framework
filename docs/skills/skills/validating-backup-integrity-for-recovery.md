---
title: "Validating Backup Integrity For Recovery  Claude Code Plugin & Agent Skill"
description: "Validate backup integrity through cryptographic hash verification, automated restore testing, corruption detection, and recoverability checks to. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge"> `validating-backup-integrity-for-recovery`</span>
<span class="meta-badge"> <a href="https://github.com/galyarderlabs/galyarder-framework/tree/main/skills/validating-backup-integrity-for-recovery/SKILL.md">Source</a></span>
</div>
