---
title: "Remotion Engineer  Claude Code Plugin & Agent Skill"
description: "Remotion specialist for programmatic video generation using React. Use PROACTIVELY when the user wants to create, debug, or optimize Remotion video. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge"> `remotion-engineer`</span>
<span class="meta-badge"> <a href="https://github.com/galyarderlabs/galyarder-framework/tree/main/skills/remotion-engineer/SKILL.md">Source</a></span>
</div>
