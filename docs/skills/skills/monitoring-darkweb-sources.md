---
title: "Monitoring Darkweb Sources  Claude Code Plugin & Agent Skill"
description: "Monitors dark web forums, marketplaces, paste sites, and ransomware leak sites for mentions of organizational assets, leaked credentials, threatened. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge"> `monitoring-darkweb-sources`</span>
<span class="meta-badge"> <a href="https://github.com/galyarderlabs/galyarder-framework/tree/main/skills/monitoring-darkweb-sources/SKILL.md">Source</a></span>
</div>
