---
title: "Product Marketing Context  Claude Code Plugin & Agent Skill"
description: "Create or update a reusable product marketing context document with positioning, audience, ICP, use cases, and messaging. Use at the start of a. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge"> `product-marketing-context`</span>
<span class="meta-badge"> <a href="https://github.com/galyarderlabs/galyarder-framework/tree/main/skills/product-marketing-context/SKILL.md">Source</a></span>
</div>
