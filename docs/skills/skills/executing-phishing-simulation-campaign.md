---
title: "Executing Phishing Simulation Campaign  Claude Code Plugin & Agent Skill"
description: "Executes authorized phishing simulation campaigns to assess an organization's susceptibility to email-based social engineering attacks. The tester. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge"> `executing-phishing-simulation-campaign`</span>
<span class="meta-badge"> <a href="https://github.com/galyarderlabs/galyarder-framework/tree/main/skills/executing-phishing-simulation-campaign/SKILL.md">Source</a></span>
</div>
