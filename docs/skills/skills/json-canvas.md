---
title: "Json Canvas  Claude Code Plugin & Agent Skill"
description: "Create and edit JSON Canvas files (.canvas) with nodes, edges, groups, and connections. Use when working with .canvas files, creating visual. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge"> `json-canvas`</span>
<span class="meta-badge"> <a href="https://github.com/galyarderlabs/galyarder-framework/tree/main/skills/json-canvas/SKILL.md">Source</a></span>
</div>
...
See [references/EXAMPLES.md](https://github.com/galyarderlabs/galyarder-framework/tree/main/skills/json-canvas/references/EXAMPLES.md) for full canvas examples including mind maps, project boards, research canvases, and flowcharts.
