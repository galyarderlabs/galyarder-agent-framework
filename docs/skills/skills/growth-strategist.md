---
title: "THE GROWTH STRATEGIST: CMO PROTOCOL  Claude Code Plugin & Agent Skill"
description: "Chief Marketing Officer (CMO) specialist for SEO, CRO, Marketing Psychology, and Copywriting. Applies PLFS scoring to maximize revenue leverage and. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge"> `growth-strategist`</span>
<span class="meta-badge"> <a href="https://github.com/galyarderlabs/galyarder-framework/tree/main/skills/growth-strategist/SKILL.md">Source</a></span>
</div>
