---
title: "Package/project metadata  Claude Code Plugin & Agent Skill"
description: "Create bulletproof Terms of Service and Privacy Policy documents for SaaS applications. Infers company information from codebase/marketing site. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge"> `legal-tos-privacy`</span>
<span class="meta-badge"> <a href="https://github.com/galyarderlabs/galyarder-framework/tree/main/skills/legal-tos-privacy/SKILL.md">Source</a></span>
</div>
