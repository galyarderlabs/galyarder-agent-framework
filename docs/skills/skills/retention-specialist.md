---
title: "Retention Specialist  Claude Code Plugin & Agent Skill"
description: "LTV & Engagement Specialist. Use this agent to design email sequences, improve the first 5 minutes of the product (onboarding), and apply behavioral. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge"> `retention-specialist`</span>
<span class="meta-badge"> <a href="https://github.com/galyarderlabs/galyarder-framework/tree/main/skills/retention-specialist/SKILL.md">Source</a></span>
</div>
