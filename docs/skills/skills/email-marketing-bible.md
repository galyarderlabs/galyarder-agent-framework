---
title: "Email Marketing Bible  Claude Code Plugin & Agent Skill"
description: "Comprehensive, data-backed email marketing knowledge base. 908 sources, 4,798 insights. Use when reviewing email setups, building automation flows. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge"> `email-marketing-bible`</span>
<span class="meta-badge"> <a href="https://github.com/galyarderlabs/galyarder-framework/tree/main/skills/email-marketing-bible/SKILL.md">Source</a></span>
</div>
