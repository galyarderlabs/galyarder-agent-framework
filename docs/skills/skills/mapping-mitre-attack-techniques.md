---
title: "Mapping Mitre Attack Techniques  Claude Code Plugin & Agent Skill"
description: "Maps observed adversary behaviors, security alerts, and detection rules to MITRE ATT&CK techniques and sub-techniques to quantify detection coverage. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge"> `mapping-mitre-attack-techniques`</span>
<span class="meta-badge"> <a href="https://github.com/galyarderlabs/galyarder-framework/tree/main/skills/mapping-mitre-attack-techniques/SKILL.md">Source</a></span>
</div>
