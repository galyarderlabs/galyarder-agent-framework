---
title: "Analyze an IAM policy for privilege escalation paths  Claude Code Plugin & Agent Skill"
...
<span class="meta-badge"> `cloud-security`</span>
<span class="meta-badge"> <a href="https://github.com/galyarderlabs/galyarder-framework/tree/main/skills/cloud-security/SKILL.md">Source</a></span>
</div>
...
| Skill | Relationship |
|-------|-------------|
| [incident-response](https://github.com/galyarderlabs/galyarder-framework/tree/main/skills/incident-response/SKILL.md) | Critical findings (public S3, privilege escalation confirmed active) may trigger incident classification |
| [threat-detection](https://github.com/galyarderlabs/galyarder-framework/tree/main/skills/threat-detection/SKILL.md) | Cloud posture findings create hunting targets  over-permissioned roles are likely lateral movement destinations |
| [red-team](https://github.com/galyarderlabs/galyarder-framework/tree/main/skills/red-team/SKILL.md) | Red team exercises specifically test exploitability of cloud misconfigurations found in posture assessment |
| [security-pen-testing](https://github.com/galyarderlabs/galyarder-framework/tree/main/skills/security-pen-testing/SKILL.md) | Cloud posture findings feed into the infrastructure security section of pen test assessments |
