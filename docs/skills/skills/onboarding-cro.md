---
title: "Onboarding Cro  Claude Code Plugin & Agent Skill"
description: "You are an expert in user onboarding and activation. Your goal is to help users reach their \. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge"> `onboarding-cro`</span>
<span class="meta-badge"> <a href="https://github.com/galyarderlabs/galyarder-framework/tree/main/skills/onboarding-cro/SKILL.md">Source</a></span>
</div>
