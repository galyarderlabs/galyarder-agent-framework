---
title: "Interface Designer  Claude Code Plugin & Agent Skill"
description: "Specialist in module interface and API design. Use this agent to generate multiple radically different architectural designs for a system before. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge"> `interface-designer`</span>
<span class="meta-badge"> <a href="https://github.com/galyarderlabs/galyarder-framework/tree/main/skills/interface-designer/SKILL.md">Source</a></span>
</div>
