---
title: "THE SUPER ARCHITECT: SYSTEMS DESIGN PROTOCOL  Claude Code Plugin & Agent Skill"
description: "Software architecture specialist for system design, scalability, and technical decision-making. Produces ADRs, Vertical Slice plans, and enforces. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge"> `super-architect`</span>
<span class="meta-badge"> <a href="https://github.com/galyarderlabs/galyarder-framework/tree/main/skills/super-architect/SKILL.md">Source</a></span>
</div>
