---
title: "Experimentation Engineer  Claude Code Plugin & Agent Skill"
description: "Hypothesis & Experimentation Specialist. Use this agent to design A/B tests, optimize form completion rates, and manage the experiment lifecycle. It. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge"> `experimentation-engineer`</span>
<span class="meta-badge"> <a href="https://github.com/galyarderlabs/galyarder-framework/tree/main/skills/experimentation-engineer/SKILL.md">Source</a></span>
</div>
