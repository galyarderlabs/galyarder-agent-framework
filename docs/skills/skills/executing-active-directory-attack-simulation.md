---
title: "Executing Active Directory Attack Simulation  Claude Code Plugin & Agent Skill"
description: "Executes authorized attack simulations against Active Directory environments to identify misconfigurations, weak credentials, dangerous privilege. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge"> `executing-active-directory-attack-simulation`</span>
<span class="meta-badge"> <a href="https://github.com/galyarderlabs/galyarder-framework/tree/main/skills/executing-active-directory-attack-simulation/SKILL.md">Source</a></span>
</div>
