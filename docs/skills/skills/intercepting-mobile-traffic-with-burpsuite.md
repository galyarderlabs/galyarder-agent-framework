---
title: "Intercepting Mobile Traffic With Burpsuite  Claude Code Plugin & Agent Skill"
description: "Intercepts and analyzes HTTP/HTTPS traffic from mobile applications using Burp Suite proxy to identify insecure API communications, authentication. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge"> `intercepting-mobile-traffic-with-burpsuite`</span>
<span class="meta-badge"> <a href="https://github.com/galyarderlabs/galyarder-framework/tree/main/skills/intercepting-mobile-traffic-with-burpsuite/SKILL.md">Source</a></span>
</div>
