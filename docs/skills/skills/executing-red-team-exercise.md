---
title: "Executing Red Team Exercise  Claude Code Plugin & Agent Skill"
description: "Executes comprehensive red team exercises that simulate real-world adversary operations against an organization's people, processes, and technology. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge"> `executing-red-team-exercise`</span>
<span class="meta-badge"> <a href="https://github.com/galyarderlabs/galyarder-framework/tree/main/skills/executing-red-team-exercise/SKILL.md">Source</a></span>
</div>
