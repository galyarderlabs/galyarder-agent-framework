---
title: "Dispatching Parallel Agents  Claude Code Plugin & Agent Skill"
description: "Use when facing 2+ independent tasks that can be worked on without shared state or sequential dependencies. Agent skill for Claude Code, Codex CLI, Gemini CLI, OpenClaw."
---
...
<span class="meta-badge"> `dispatching-parallel-agents`</span>
<span class="meta-badge"> <a href="https://github.com/galyarderlabs/galyarder-framework/tree/main/skills/dispatching-parallel-agents/SKILL.md">Source</a></span>
</div>
