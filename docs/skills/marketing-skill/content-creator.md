---
title: "Content Creator  Agent Skill for Marketing"
...
<span class="meta-badge"> <a href="https://github.com/galyarderlabs/galyarder-framework/tree/main/marketing-skill/content-creator/SKILL.md">Source</a></span>
</div>
...
|----------------|-----------------|
| **Write** a blog post, article, or guide | [content-production](https://github.com/galyarderlabs/galyarder-framework/tree/main/marketing-skill/content-production) |
| **Plan** what content to create, topic clusters, calendar | [content-strategy](https://github.com/galyarderlabs/galyarder-framework/tree/main/marketing-skill/content-strategy) |
| **Analyze brand voice** | [content-production](https://github.com/galyarderlabs/galyarder-framework/tree/main/marketing-skill/content-production) (includes `brand_voice_analyzer.py`) |
| **Optimize SEO** for existing content | [content-production](https://github.com/galyarderlabs/galyarder-framework/tree/main/marketing-skill/content-production) (includes `seo_optimizer.py`) |
| **Create social media content** | [social-content](https://github.com/galyarderlabs/galyarder-framework/tree/main/marketing-skill/social-content) |
