...
# IMPORTANT: Run from galyarder-framework directory so local dev skills are available
...
if grep -q '"name":"Skill".*"skill":"galyarder-framework:subagent-driven-development"' "$SESSION_FILE"; then
