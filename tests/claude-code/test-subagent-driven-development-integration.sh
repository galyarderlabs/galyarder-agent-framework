...
mkdir -p src test docs/galyarder-agent-framework/plans

# Create a simple implementation plan
cat > docs/galyarder-agent-framework/plans/implementation-plan.md <<'EOF'
...
I want you to execute the implementation plan at docs/galyarder-agent-framework/plans/implementation-plan.md using the subagent-driven-development skill.
...
# IMPORTANT: Run from galyarder-agent-framework directory so local dev skills are available
PROMPT="Change to directory $TEST_PROJECT and then execute the implementation plan at docs/galyarder-agent-framework/plans/implementation-plan.md using the subagent-driven-development skill.
...
if grep -q '"name":"Skill".*"skill":"galyarder-agent-framework:subagent-driven-development"' "$SESSION_FILE"; then
