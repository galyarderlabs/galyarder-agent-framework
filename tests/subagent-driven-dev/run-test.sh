...
#   ./run-test.sh svelte-todo --plugin-dir /path/to/galyarder-agent-framework
...
TIMESTAMP=$(date +%s)
OUTPUT_BASE="/tmp/galyarder-agent-framework-tests/$TIMESTAMP/subagent-driven-development"
...
PROMPT="Execute this plan using galyarder-agent-framework:subagent-driven-development. The plan is at: $PLAN_PATH"
