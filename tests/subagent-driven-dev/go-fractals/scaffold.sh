...
echo "  claude -p \"Execute this plan using galyarder-agent-framework:subagent-driven-development. Plan: $TARGET_DIR/plan.md\" --plugin-dir /path/to/galyarder-agent-framework"
