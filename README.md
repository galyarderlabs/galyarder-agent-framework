...
- **Executive**: `galyarder-ceo`, `galyarder-specialist`. Strategic oversight and master orchestration.
...
- **Legal-Finance**: `legal-counsel`, `finops-manager`. Regulatory compliance and token FinOps.
