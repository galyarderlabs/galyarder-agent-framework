...
description: "Specialist in module interface and API design. Use this agent to generate multiple radically different architectural designs for a system before implementation. It enforces the 'design-an-interface' skill to ensure clean, decoupled, and testable abstractions."
risk: low
source: internal
